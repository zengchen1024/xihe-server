...
func (cli *mongodbClient) newDocIfNotExist(
...
func (cli *mongodbClient) replaceDoc(
	ctx context.Context, collection string,
	filterOfDoc, docInfo bson.M,
) (string, error) {
	upsert := true
...
func (cli *mongodbClient) updateDoc(
	ctx context.Context, collection string,
...
func (cli *mongodbClient) getDocs(
	ctx context.Context, collection string,
	filterOfDoc, project bson.M, result interface{},
) error {
	col := cli.Collection(collection)
...
func (cli *mongodbClient) addToSimpleArray(
...
func (cli *mongodbClient) removeFromSimpleArray(
	ctx context.Context,
...
func (cli *mongodbClient) pushArrayElem(
	ctx context.Context,
	collection, array string,
...
func (cli *mongodbClient) pushElemToLimitedArray(
	ctx context.Context,
...
func (cli *mongodbClient) pullNestedArrayElem(
	ctx context.Context, collection, array string,
...
func (cli *mongodbClient) pushNestedArrayElem(
	ctx context.Context, collection, array string,
	filterOfDoc, filterOfArray, data bson.M,
	version int, t int64,
) (bool, error) {
...
func (cli *mongodbClient) updateArrayElem(
	ctx context.Context, collection, array string,
...
func (cli *mongodbClient) modifyArrayElem(
	ctx context.Context, collection, array string,
	filterOfDoc, filterOfArray, updateCmd bson.M,
...
func (cli *mongodbClient) modifyArrayElemWithoutVersion(
	ctx context.Context, collection, array string,
	filterOfDoc, filterOfArray, updateCmd bson.M,
	op string,
) (bool, error) {
...
func (cli *mongodbClient) updateArrayElemCount(
	ctx context.Context,
...
func (cli *mongodbClient) isArrayElemExists(
...
func (cli *mongodbClient) isArrayDocExists(
	ctx context.Context, collection string,
...
func (cli *mongodbClient) containsArrayElem(
	ctx context.Context, collection string, filterOfDoc bson.M,
) (bool, error) {
	var v struct {
...
func (cli *mongodbClient) pullArrayElem(
	ctx context.Context, collection, array string,
	filterOfDoc, filterOfArray bson.M,
) error {
...
func (cli *mongodbClient) getArrayElem(
	ctx context.Context, collection, array string,
	filterOfDoc, filterOfArray bson.M,
...
func (cli *mongodbClient) getArraysElem(
	ctx context.Context, collection string,
...
func (cli *mongodbClient) getArraysElemsByCustomizedCond(
	ctx context.Context, collection string,
...
func (cli *mongodbClient) getArraysElemsHelper(
	ctx context.Context, collection string,
	filterOfDoc bson.M, filterOfArrays map[string]bson.M,
	project bson.M, result interface{},
) error {
